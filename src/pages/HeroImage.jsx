...
const HeroImage = () => {
  return (
    <div className='w-full flex flex-col justify-between overflow-hidden'>
      <div className='bg-[#140624]  h-[320px] md:h-[420px] lg:h-[450px] xl:h-[450px] 2xl:h-[450px] w-full relative mt-20'>
        <div className='grid md:grid-cols-3 justify-between md:ml-[90px] lg:ml-[40px] 2xl:ml-[300px] rounded-xl'>
          <div className=' col-start-1 col-end-3 mx-6 md:mx-16 mt-10 md:mt-20 2xl:mt-20'>
            <div className=' h-[50%]'>
            <h1 className='md:text-3xl xl:text-5xl font-bold text-white'>BUY & SELL DIGITAL NFT token</h1>
              ...
              <button className='border-none text-white pt-4 bg-blue-300'>Get Started Now</button>
            </div>
            <div className='flex  items-center mt-4 md:mt-5 2xl:mt-7 w-full '>
              ...
              <div className=' px-4 xl:px-0 w-[150px]'>
                <p className='text-slate-400'>Lorem ipsum dolor sit, amet consectetur adipisicing elit.</p> </div>
            </div>
          </div>
          <div className='h-full '>
            <img className='hidden md:flex items-center w-[70%] mt-40' src={image1} alt="/" />
          </div>
        </div>
