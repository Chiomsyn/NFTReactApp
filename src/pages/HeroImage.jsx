        ...
        <div className='grid md:grid-cols-3 justify-between md:mx-[30px] lg:ml-[100px] 2xl:ml-[300px] rounded-xl'>
          <div className='flex-col col-start-1 col-end-3 mx-6 md:mx-16 mt-16 md:mt-28 2xl:mt-20'>
            ...
            <div className='flex mt-4  md:mt-5 2xl:mt-7 h-[35%] w-full '>
              ...
              <div className='h-full px-4 xl:px-0 w-[70%] xl:w-[40%] items-center flex xl:items-end'>
                <p className='text-slate-400'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quis recusandae. </p> </div>
            </div>
          </div>
