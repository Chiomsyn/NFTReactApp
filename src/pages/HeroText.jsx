            ...
            <div className=''>
                <div className='flex flex-col md:ml-10 justify-center text-center'>
                    <div className='flex justify-center flex-wrap px-4'>
                        ...
                        <p className='flex text-red-500 px-10 py-2 font-medium text-2xl'>BuzzFeed</p>
                        <p className='flex text-blue-900 px-10 py-2 font-medium text-2xl'>Booking<span className='text-blue-300'>.com</span></p>
                        <p className='flex text-blue-900 px-10 py-2 font-medium text-2xl'>Expedia</p>
                ...
                <div className='bg-[#2F313E] my-20 lg:h-[470px]'>
                    <div className='mt-10 py-6 max-w-[1240px] mx-4 sm:mx-[70px] xl:mx-[100px] 2xl:mx-auto lg:flex '>
                        <div className=' flex-col pt-10 mr-10 items-center pl-10 hover:bg-[#414654] h-full w-full rounded-2xl my-10'>
                        ...
                        <div className='mr-10 flex-col pt-1 items-center pl-10 hover:bg-[#414654] h-full w-full rounded-2xl my-10'>
                        ...
                        <div className=' flex-col items-center pt-1 pl-10 hover:bg-[#414654] h-full w-full rounded-2xl my-10'>
